...
namespace Sudoku1
{
    public class Solver
    {
        ...
        /// <summary>
        /// W statycznej metodzie MakeBoard, dla optymalniejszego działania algorytmu z listy tworzymy tablicę
        /// </summary>
        ...
        /// <summary>
        /// Sprawdza czy można uzupełnić daną komórkę podaną liczbą
        /// </summary>
        ...
        /// <summary>
        /// Rozwiązuje sudoku dla podanej tablicy.
        /// </summary>
        /// <param name="board"></param>
        /// <returns></returns>
        ...
        /// <summary>
        /// Znajduje pole, które ma wartość 0.
        /// </summary>
        /// <param name="board"></param>
        /// <param name="row"></param>
        /// <param name="col"></param>
